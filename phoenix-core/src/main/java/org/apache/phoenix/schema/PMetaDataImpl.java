...
public class PMetaDataImpl implements PMetaData {
    ...
    public void addTable(PTable table, long resolvedTime) throws SQLException {
        ...
        if (table.getPhysicalTableNameColumnInSyscat() != null && !table.getPhysicalTableNameColumnInSyscat().getString().equals(table.getTableName().getString())) {
            String physicalTableName =  table.getPhysicalTableNameColumnInSyscat().getString().replace(

...
public class PTableImpl implements PTable {
    ...
    private final PName parentLogicalName;
    ...
    public static class Builder {
        ...
        private PName parentLogicalName;
        ...
        public Builder setParentLogicalName(PName parentLogicalName) {
        ...
        private Builder initDerivedAttributes() throws SQLException {
            ...
            PName parentTblFullName = this.parentTableName == null ? null : PNameFactory.newName(SchemaUtil.getTableName(
                    this.parentSchemaName != null ?
                            this.parentSchemaName.getString() : null,
                    this.parentTableName.getString()));
            System.out.println("GOKCEN parentName=" + (this.parentName == null ? "null" : parentName)  + "parentTableName=" +(this.parentTableName == null ? "null" : parentTblFullName.getString()) );
            return this.setName(fullName)
                    .setKey(new PTableKey(this.tenantId, fullName.getString()))
                    .setParentTableName(this.parentTableName)
                    .setParentSchemaName(this.parentSchemaName)
                    //.setParentName(this.parentName != null ? parentName : parentTblFullName)
    ...
    private PTableImpl(Builder builder) {
        ...
        this.parentLogicalName = builder.parentLogicalName;
    ...
    private static PTableImpl.Builder builderFromExisting(PTable table) {
        return new PTableImpl.Builder()
                ...
                .setPhysicalTableName(table.getPhysicalTableNameColumnInSyscat())
                ...
                //.setParentLogicalName(table.getParentLogicalName())
    ...
    @Override
    public final PName getPhysicalTableNameColumnInSyscat() {
    ...
    public PName getParentTableName() {
        ...
        return (type!=PTableType.VIEW || parentTableName!=null) ? parentTableName :
    ...
    public PName getParentName() {
        ...
        return (type!=PTableType.VIEW || parentName!=null) ? parentName :
                ((parentLogicalName != null && !Strings.isNullOrEmpty(parentLogicalName.getString()))? parentLogicalName
                        : getPhysicalName());
//        PName result = null;
//        if (parentName != null && !Strings.isNullOrEmpty(parentName.getString())) {
//            result = parentName;
//        } else {
...
//        return result;
    ...
    public PName getParentLogicalName() {
        PName result = null;
        if (parentLogicalName != null && !Strings.isNullOrEmpty(parentLogicalName.getString())) {
            result = parentLogicalName;
        } else {
            if (parentName != null) {
                result = parentName;
            } else {
    ...
    public static PTable createFromProto(PTableProtos.PTable table) {
        ...
        if (table.getParentLogicalNameBytes() != null) {
            parentLogicalName = PNameFactory.newName(table.getParentLogicalNameBytes().toByteArray());
        }
        ...
        try {
            return new PTableImpl.Builder()
                    ...
                    .setParentLogicalName(parentLogicalName)
    ...
    public static PTableProtos.PTable toProto(PTable table) {
        ...
        if (table.getPhysicalTableNameColumnInSyscat() == null) {
            builder.setPhysicalTableNameBytes(ByteStringer.wrap(table.getTableName().getBytes()));
        } else {
            builder.setPhysicalTableNameBytes(ByteStringer.wrap(table.getPhysicalTableNameColumnInSyscat().getBytes()));
        }
...
//        }
        ...
        if (table.getParentLogicalName() != null) {
            builder.setParentLogicalNameBytes(ByteStringer.wrap(table.getParentLogicalName().getBytes()));
        }

...
public class PTableImpl implements PTable {
    ...
    private final PName physicalTableName;
    ...
    private static PTableImpl.Builder builderFromExisting(PTable table) {
        return new PTableImpl.Builder()
                ...
                .setPhysicalTableName(table.getPhysicalTableName())
    ...
    public PName getParentLogicalName() {
        return parentLogicalName != null ? parentLogicalName:getParentName();
    }
    ...
    public PName getPhysicalName() {
        ...
        if (physicalNames.isEmpty()) {
            if (physicalTableName != null && !Strings.isNullOrEmpty(physicalTableName.getString())) {
                return SchemaUtil.getPhysicalHBaseTableName(schemaName, physicalTableName, isNamespaceMapped);
            }
    ...
    public static PTableProtos.PTable toProto(PTable table) {
        ...
        if (table.getPhysicalTableName() == null) {
            ...
            builder.setPhysicalTableNameBytes(ByteStringer.wrap(table.getPhysicalTableName().getBytes()));
        }

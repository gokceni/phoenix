...
public class PhoenixStatement implements Statement, SQLCloseable {
    ...
    private static class ExecutableAlterIndexStatement extends AlterIndexStatement implements CompilableStatement {
        ...
        public ExecutableAlterIndexStatement(NamedTableNode indexTableNode, String dataTableName, boolean ifExists, PIndexState state, boolean isAll, boolean async, ListMultimap<String,Pair<String,Object>> props) {
            super(indexTableNode, dataTableName, ifExists, state, isAll, async, props);
        }
    ...
    protected static class ExecutableNodeFactory extends ParseNodeFactory {
        ...
        @Override
        public AlterIndexStatement alterIndex(NamedTableNode indexTableNode, String dataTableName, boolean ifExists, PIndexState state, boolean isAll, boolean async, ListMultimap<String,Pair<String,Object>> props) {
            return new ExecutableAlterIndexStatement(indexTableNode, dataTableName, ifExists, state, isAll, async, props);
        }
